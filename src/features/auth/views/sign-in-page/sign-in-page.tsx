    ...
    <>
      <div className='min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
          <Link to='/'>
            <img className='mx-auto h-12 w-auto' src='images/logo.png' alt='Coffee and Code Logo' />
          </Link>
              ...
              <div className='relative'>
                ...
                <div>
                  ...
                  >
                    ...
                    <svg className='w-5 h-6' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20'>
                      <path
                        fillRule='evenodd'
