                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-start'>
                    ...
                    <label htmlFor='remember-me' className='ml-2 block text-sm text-gray-900'>
                      ...
                      <a href='#cloud-terms-of-service' className='text-indigo-600 hover:text-indigo-500'>
                        Terms of Service
                      </a>
                      <span> and </span>
                      <a href='#cloud-terms-of-service' className='text-indigo-600 hover:text-indigo-500'>
              ...
              <div>
                <div className='mt-4 relative'>
                  ...
                  <div className='relative flex justify-center text-sm'>
                    <span className='px-2 bg-white text-gray-200'>Or continue with</span>
                  </div>
                </div>
                  ...
                  <div className='mt-1 grid grid-cols-3 gap-3'>
                    <div>
                      ...
                      >
                        ...
                        <svg className='w-5 h-5' aria-hidden='true' fill='currentColor' viewBox='0 0 10 10'>
                          <path
                            fillRule='evenodd'
